...
def H2(T, c2ev = 0, P = 1):
    """ 
    Enthalpy, entropy for gas hydrogen relative to H°298.15 and at 1 bar pressure
    ...
    if 298 <= T <= 1000: # 298 - 1000 
        ...
        printlog('No calorimetry data for H2 molecule under 298 K')
